...
const IconCart = () => {
  ...
  return (
    <button onClick={() => setCartIsVisible(!cartIsVisible)} type='button' className={cartIsVisible ? "w-10 h-10 flex items-center justify-center bg-white/10 rounded-2xl relative duration-300" : "w-10 h-10 flex items-center justify-center rounded-2xl relative duration-300"}>
